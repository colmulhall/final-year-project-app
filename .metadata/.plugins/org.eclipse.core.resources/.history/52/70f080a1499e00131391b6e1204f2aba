...
public class TwitterFeedActivity extends ListActivity {
	...
	private class DownloadTwitterTask extends AsyncTask<String, Void, String> {
		final static String CONSUMER_KEY = "HJTjGF25dgGbPAvSOHe6VA";
		final static String CONSUMER_SECRET = "iS7XoeFHZqPBMAWD5tdkGn9y2tyNIz6IKA1YLHfiI";
		final static String TwitterTokenURL = "https://api.twitter.com/oauth2/token";
		final static String TwitterStreamURL = "https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name=colmulhall77";
