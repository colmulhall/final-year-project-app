...
public class EventList extends ListActivity 
{
	...
	// testing on Emulator:
	private static final String READ_COMMENTS_URL = "http://10.0.2.2/FYP-Web-Coding/android_connect.php";
	...
	private void updateList() 
	{
		...
		ListAdapter adapter = new SimpleAdapter(this, mCommentList,
				R.layout.single_list_item, new String[] { TAG_TITLE, TAG_MESSAGE,
						TAG_USERNAME }, new int[] { R.id.title });
